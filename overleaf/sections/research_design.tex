...
This study examines whether unusually large individual trades are associated with short-horizon movements in Polymarket-implied probabilities, whether those movements persist or reverse, and whether they improve alignment with eventual market outcomes. The design is observational: it estimates conditional associations and does not claim that a trade caused a price change, conveyed private information, or manipulated a market. The primary outcome is described as a recorded-price adjustment, and the estimated coefficients as directional price associations.
...
available at:
\url{https://github.com/andrew1004aa/polymarket-world-cup-2026/tree/v1.0.0-submission}.
