...
900-second matching tolerances. The focal minute is excluded from the executed-
price baseline.
...
The complete reproducibility package, including the data-collection,
sample-construction, regression, machine-learning, and audit code, is available
at the following public repository:
\url{https://github.com/andrew1004aa/polymarket-world-cup-2026}.
The fixed snapshot corresponding to this revision is release
\url{https://github.com/andrew1004aa/polymarket-world-cup-2026/releases/tag/v0.3-supervisor-revision}.
The final submitted version will receive a separate submission tag.
