...
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}p{0.39\linewidth}rrrr@{}}
\hline
...
\footnotesize Notes: The pooled five-minute sample contains 794,178
observations. Models use common controls, market and calendar-hour fixed
effects, and CRV1 standard errors clustered by 104 events. Post-kickoff means
before recorded resolution and is not necessarily purely in-play.
\end{minipage}
\end{table}
