...
\hline
H1 (baseline): total flow and short-horizon price & Supported (conditional association); baseline sanity check for the directional-flow measure & $\beta=0.000071$, $p<0.001$ \\ \hline
...
H3a: subsequent continuation, minute 5 to 15 & Supported in the unconditional minute-5-to-minute-15 specification; the conditional non-zero-initial-movement evidence is not statistically significant. & Diff $=0.000016$, $p=0.007$ \\ \hline
