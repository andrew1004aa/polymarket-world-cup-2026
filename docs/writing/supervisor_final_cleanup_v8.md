...
over-strong H1 wording, corrects the Della Vedova grammar, and improves the
readability of four tables without changing any empirical value. README code
fences were mechanically checked and are balanced; the v6 command block
